  ...
  return (
    ...
    >
      ...
      <div className="picker-body">
        {activeTab === 'emoji' && <EmojiGrid onPick={(char) => { hapticSelect(); playTap(); onEmoji?.(char); }} />}
        {mode === 'full' && activeTab === 'gif' && <GiphyGrid contentFilter="gif" onPick={(url, type) => { hapticSelect(); playTap(); onMedia?.(url, type); }} />}
        {mode === 'full' && activeTab === 'sticker' && <GiphyGrid contentFilter="sticker" onPick={(url, type) => { hapticSelect(); playTap(); onMedia?.(url, type); }} />}
      </div>
    </div>
  );
}
