...
function ReadOnlyGroupInput({ icon, label, value, isTextArea = false }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 34, height: 34, flexShrink: 0, borderRadius: 14, background: 'rgba(63,120,255,0.06)', color: 'var(--dim)', marginTop: isTextArea ? 2 : 0 }}>
        {icon}
      </div>
            ...
            {loading ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
                  <div style={{ width: 148, height: 148, borderRadius: '50%', padding: 4, background: 'linear-gradient(135deg, var(--ember), #FFB199)', boxShadow: '0 10px 30px rgba(47,111,255,0.20), 0 4px 14px rgba(0,0,0,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24, width: '100%' }}>
                  <div>
                    ...
                    <div className="glass-panel" style={{ padding: 10, background: 'var(--glass)' }}>
