...
export default function ConfessionBubble({ confession, onReply, onPhotoClick, size = 'inline' }) {
  ...
  if (storyStyle && confession.text) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: preset.maxWidth || 340, margin: isStory ? 0 : '16px auto' }}>
  ...
  return (
    <div
      style={{
        ...
        alignItems: 'center',
        width: '100%',
        maxWidth: preset.maxWidth || 340,
        margin: isStory ? 0 : '16px auto',
      }}
    >
