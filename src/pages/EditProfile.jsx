...
const Vectors = {
  ...
  Sun: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4" /><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41" /></svg>,
    ...
    <div
      style={{
        ...
        boxShadow: isFocused && !readOnly
          ? '0 0 0 5px rgba(47,111,255,0.14), 0 6px 16px rgba(0,0,0,0.25)'
    ...
    >
      <div
        style={{
          ...
          flexShrink: 0,
          borderRadius: 14,
          background: isFocused && !readOnly ? 'rgba(47,111,255,0.18)' : 'rgba(63,120,255,0.06)',
...
function SectionLabel({ icon, children }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 10px 4px' }}>
      {icon && (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 22, height: 22, borderRadius: 8, background: 'rgba(47,111,255,0.14)', color: 'var(--ember)' }}>
          {icon}
        </div>
      )}
      ...
      >
        ...
        <div className="custom-scrollbar" style={{ flex: 1, overflowY: 'auto', padding: '28px 20px 60px' }}>
          <div style={{ maxWidth: 440, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 30 }}>
            ...
            <div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  <div style={{ width: 40, height: 40, borderRadius: 14, background: 'rgba(47,111,255,0.14)', color: 'var(--ember)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>{Vectors.Bell}</div>
            ...
            <div>
              <SectionLabel icon={Vectors.Sun}>Appearance</SectionLabel>
              <div
                className="glass-panel"
                style={{
                  display: 'flex',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 14, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 2, minWidth: 0 }}>
                    <span style={{ fontSize: 15.5, fontWeight: 700, color: 'var(--paper)' }}>
                      Light mode
                    </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: hasChanges ? '0 10px 26px rgba(61,139,255,0.35)' : 'none',
