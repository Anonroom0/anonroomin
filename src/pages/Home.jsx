 ...
 * - FIX: "Download app" control is a real <a href="/apk/download/"> anchor
 *   with a data-hard-nav attribute. main.jsx installs a global, capture-
 *   phase click listener that hijacks every same-origin anchor click into
 *   a client-side pushState (that's what powers the rest of the app's fast
 *   in-app navigation) — but /apk/download/ is a standalone static page,
 *   not a route this SPA's router (resolveActiveChatFromLocation) knows
 *   how to render, so that pushState was silently rewriting the URL bar
 *   with nothing to show until a manual refresh forced a real request.
 *   data-hard-nav is the escape hatch main.jsx's interceptor already
 *   checks for and skips, so this anchor now gets a normal, full-page
 *   navigation straight to the real page.
 * 
