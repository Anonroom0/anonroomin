...
import { playReceive, playError, playRefreshComplete } from '../lib/soundManager';
...
export default function ToastContainer() {
  ...
  useEffect(() => {
    ...
    function handleToastEvent(event) {
      ...
      // Every toast gets a matching sound + haptic for free, right at this
      // single dispatch point — individual showToast() call sites never
      // need to remember to wire it up themselves.
      if (safeType === 'error') { playError(); hapticError(); }
      else if (safeType === 'success') { playRefreshComplete(); hapticSuccess(); }
      else { playReceive(); hapticTap(); }
