      ...
      >
        ...
        {stage === 'invalid' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, padding: '12px 0', textAlign: 'center' }}>
            ...
            <h1 style={{ margin: '4px 0 0', fontSize: 20, fontWeight: 800, color: 'var(--paper)' }}>Link expired</h1>
        ...
        {stage === 'success' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, padding: '24px 0', textAlign: 'center' }}>
            ...
            <h1 style={{ margin: '4px 0 0', fontSize: 20, fontWeight: 800, color: 'var(--paper)' }}>Password updated</h1>
        ...
        {(stage === 'form' || stage === 'saving') && (
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div style={{ textAlign: 'center' }}>
              <h1 style={{ margin: '0 0 6px', fontSize: 22, fontWeight: 800, color: 'var(--paper)' }}>Set a new password</h1>
