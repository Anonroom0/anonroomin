...
// ============================================================================
const Icons = {
  // Replaces the old three-dot kebab — a proper share glyph (arrow breaking
  // out of a box) reads immediately as "share this", matches the outlined-
  // stroke style every other icon here uses, and is drawn bigger/bolder so
  // it actually stands out instead of blending into the timestamp row.
  Share: (
